<template>
  <div class="follow-author"
    ...
    <div v-if="showCanceling === true && cancelingSubscription === true">
      ...
      <section>
        <ul>
          <li><a href="" @click.prevent="editSubscription($event)">Edit</a></li>
          <li>
              <a v-if="subscription && subscription.renewal" href="" @click.prevent="cancelSubscription($event)">Cancel subscription</a>
              <a v-else href="" @click.prevent="renewSubscription($event)">Renew subscription</a>
          </li>
        </ul>
      </section>
    </div>
    ...
    <div v-else-if="frequency === null">
      ...
      <section>
        <ul>
          <li><a href="" @click.prevent="selectHowOften('3x_per_day', $event)">3× per day</a></li>
